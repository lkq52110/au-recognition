...
# Datasets
parser.add_argument('--dataset', default="DISFA", type=str, help="experiment dataset DISFA / EmotioNet")
...
# Experiment
parser.add_argument('--experiment', default="Test", type=str, help="experiment name for saving checkpoints")
...
def get_config():
    ...
    elif cfg.dataset == 'EmotioNet':
        with open('config/EmotioNet_config.yaml', 'r') as f:
            datasets_cfg = yaml.load(f)
            datasets_cfg = edict(datasets_cfg)
